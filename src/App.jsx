...
export default function App() {
  ...
  return (
    <div className={`min-h-screen bg-[#0f0c0b] text-[#f5ebe0] selection:bg-amber-500 selection:text-black ${phonePreviewMode ? 'py-8 px-4 flex flex-col items-center justify-center bg-zinc-950/90 min-h-screen' : ''}`}>
      ...
      <div className={phonePreviewMode ? 'w-full max-w-[420px] h-[860px] overflow-y-auto rounded-[46px] border-[10px] border-[#2a1c14] shadow-[0_25px_80px_rgba(0,0,0,0.95)] relative bg-[#0f0c0b] scrollbar-none' : 'w-full'}>
        {phonePreviewMode && (
